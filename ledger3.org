* Ledger: Command-Line Accounting
  :PROPERTIES:
  :CUSTOM_ID: ledger-command-line-accounting
  :CLASS: settitle
  :align: center
  :END:
...
** 1 Introduction to Ledger
   :PROPERTIES:
   :CUSTOM_ID: introduction-to-ledger
   :CLASS: chapter
   :END:
...
*** 1.4 Third-Party Ledger Tutorials
    :PROPERTIES:
    :CUSTOM_ID: third-party-ledger-tutorials
    :CLASS: section
    :END:
...
*** 2.1 Start a Journal File
    :PROPERTIES:
    :CUSTOM_ID: start-a-journal-file
    :CLASS: section
    :END:
...
**** 2.2.4 Using the Windows Command-Line
     :PROPERTIES:
     :CUSTOM_ID: using-the-windows-command-line
     :CLASS: subsection
     :END:
...
** 3 Principles of Accounting with Ledger
   :PROPERTIES:
   :CUSTOM_ID: principles-of-accounting-with-ledger
   :CLASS: chapter
   :END:
...
*** 3.1 Accounting with Ledger
    :PROPERTIES:
    :CUSTOM_ID: accounting-with-ledger
    :CLASS: section
    :END:
...
*** 3.2 Stating where money goes
    :PROPERTIES:
    :CUSTOM_ID: stating-where-money-goes
    :CLASS: section
    :END:
...
*** 3.3 Assets and Liabilities
    :PROPERTIES:
    :CUSTOM_ID: assets-and-liabilities
    :CLASS: section
    :END:
...
**** 3.3.1 Tracking reimbursable expenses
     :PROPERTIES:
     :CUSTOM_ID: tracking-reimbursable-expenses
     :CLASS: subsection
     :END:
...
*** 3.4 Commodities and Currencies
    :PROPERTIES:
    :CUSTOM_ID: commodities-and-currencies
    :CLASS: section
    :END:
...
**** 3.4.1 Commodity price histories
     :PROPERTIES:
     :CUSTOM_ID: commodity-price-histories
     :CLASS: subsection
     :END:
...
**** 3.4.2 Commodity equivalences
     :PROPERTIES:
     :CUSTOM_ID: commodity-equivalences
     :CLASS: subsection
     :END:
...
*** 3.5 Accounts and Inventories
    :PROPERTIES:
    :CUSTOM_ID: accounts-and-inventories
    :CLASS: section
    :END:
...
*** 3.6 Understanding Equity
    :PROPERTIES:
    :CUSTOM_ID: understanding-equity
    :CLASS: section
    :END:
...
*** 3.7 Dealing with Petty Cash
    :PROPERTIES:
    :CUSTOM_ID: dealing-with-petty-cash
    :CLASS: section
    :END:
...
*** 3.8 Working with multiple funds and accounts
    :PROPERTIES:
    :CUSTOM_ID: working-with-multiple-funds-and-accounts
    :CLASS: section
    :END:
...
*** 4.1 The Most Basic Entry
    :PROPERTIES:
    :CUSTOM_ID: the-most-basic-entry
    :CLASS: section
    :END:
...
*** 4.3 Structuring your Accounts
    :PROPERTIES:
    :CUSTOM_ID: structuring-your-accounts
    :CLASS: section
    :END:
...
*** 4.4 Commenting on your Journal
    :PROPERTIES:
    :CUSTOM_ID: commenting-on-your-journal
    :CLASS: section
    :END:
...
*** 4.5 Currency and Commodities
    :PROPERTIES:
    :CUSTOM_ID: currency-and-commodities
    :CLASS: section
    :END:
...
**** 4.5.2 Buying and Selling Stock
     :PROPERTIES:
     :CUSTOM_ID: buying-and-selling-stock
     :CLASS: subsection
     :END:
...
**** 4.5.4 Complete control over commodity pricing
     :PROPERTIES:
     :CUSTOM_ID: complete-control-over-commodity-pricing
     :CLASS: subsection
     :END:
...
*** 4.6 Keeping it Consistent
    :PROPERTIES:
    :CUSTOM_ID: keeping-it-consistent
    :CLASS: section
    :END:
...
**** 4.7.1 Transactions and Comments
     :PROPERTIES:
     :CUSTOM_ID: transactions-and-comments
     :CLASS: subsection
     :END:
...
*** 4.8 Converting from other formats
    :PROPERTIES:
    :CUSTOM_ID: converting-from-other-formats
    :CLASS: section
    :END:
...
*** 4.9 Archiving Previous Years
    :PROPERTIES:
    :CUSTOM_ID: archiving-previous-years
    :CLASS: section
    :END:
...
*** 5.10 Balance verification
    :PROPERTIES:
    :CUSTOM_ID: balance-verification
    :CLASS: section
    :END:
...
**** 5.10.1.1 Special assertion value 0
     :PROPERTIES:
     :CUSTOM_ID: special-assertion-value-0
     :CLASS: subsubsection
     :END:
...
**** 5.10.4 Balancing transactions
     :PROPERTIES:
     :CUSTOM_ID: balancing-transactions
     :CLASS: subsection
     :END:
...
*** 5.12 Explicit posting costs
    :PROPERTIES:
    :CUSTOM_ID: explicit-posting-costs
    :CLASS: section
    :END:
...
**** 5.12.1 Primary and secondary commodities
     :PROPERTIES:
     :CUSTOM_ID: primary-and-secondary-commodities
     :CLASS: subsection
     :END:
...
*** 5.13 Posting cost expressions
    :PROPERTIES:
    :CUSTOM_ID: posting-cost-expressions
    :CLASS: section
    :END:
...
*** 5.15 Virtual posting costs
    :PROPERTIES:
    :CUSTOM_ID: virtual-posting-costs
    :CLASS: section
    :END:
...
**** 5.16.1 Total commodity prices
     :PROPERTIES:
     :CUSTOM_ID: total-commodity-prices
     :CLASS: subsection
     :END:
...
*** 5.18 Fixated prices and costs
    :PROPERTIES:
    :CUSTOM_ID: fixated-prices-and-costs
    :CLASS: section
    :END:
...
*** 5.21 Lot value expressions
    :PROPERTIES:
    :CUSTOM_ID: lot-value-expressions
    :CLASS: section
    :END:
...
*** 5.22 Automated Transactions
    :PROPERTIES:
    :CUSTOM_ID: automated-transactions
    :CLASS: section
    :END:
...
**** 5.22.2 Accessing the matching posting's amount
     :PROPERTIES:
     :CUSTOM_ID: accessing-the-matching-postings-amount
     :CLASS: subsection
     :END:
...
**** 5.22.3 Referring to the matching posting's account
     :PROPERTIES:
     :CUSTOM_ID: referring-to-the-matching-postings-account
     :CLASS: subsection
     :END:
...
**** 5.22.4 Applying metadata to every matched posting
     :PROPERTIES:
     :CUSTOM_ID: applying-metadata-to-every-matched-posting
     :CLASS: subsection
     :END:
...
**** 5.22.5 Applying metadata to the generated posting
     :PROPERTIES:
     :CUSTOM_ID: applying-metadata-to-the-generated-posting
     :CLASS: subsection
     :END:
...
**** 5.22.8 Periodic Transactions
     :PROPERTIES:
     :CUSTOM_ID: periodic-transactions
     :CLASS: subsection
     :END:
...
**** 5.22.9 Concrete Example of Automated Transactions
     :PROPERTIES:
     :CUSTOM_ID: concrete-example-of-automated-transactions
     :CLASS: subsection
     :END:
...
**** 6.2.1 Controlling the Accounts and Payees
     :PROPERTIES:
     :CUSTOM_ID: controlling-the-accounts-and-payees
     :CLASS: subsection
     :END:
...
**** 6.2.2 Controlling Formatting
     :PROPERTIES:
     :CUSTOM_ID: controlling-formatting
     :CLASS: subsection
     :END:
...
**** 6.3.1 Reporting monthly expenses
     :PROPERTIES:
     :CUSTOM_ID: reporting-monthly-expenses
     :CLASS: subsection
     :END:
...
**** 6.4.2 Visualizing with Gnuplot
     :PROPERTIES:
     :CUSTOM_ID: visualizing-with-gnuplot
     :CLASS: subsection
     :END:
...
*** 7.1 Primary Financial Reports
    :PROPERTIES:
    :CUSTOM_ID: primary-financial-reports
    :CLASS: section
    :END:
...
**** 7.1.3 The =register= command
     :PROPERTIES:
     :CUSTOM_ID: the-register-command
     :CLASS: subsection
     :END:
...
*** 7.2 Reports in other Formats
    :PROPERTIES:
    :CUSTOM_ID: reports-in-other-formats
    :CLASS: section
    :END:
...
**** 7.2.1 Comma Separated Values files
     :PROPERTIES:
     :CUSTOM_ID: comma-separated-values-files
     :CLASS: subsection
     :END:
...
**** 7.2.4.1 Embedded Ledger example with single source block
     :PROPERTIES:
     :CUSTOM_ID: embedded-ledger-example-with-single-source-block
     :CLASS: subsubsection
     :END:
...
**** 7.2.4.2 Multiple Ledger source blocks with =noweb=
     :PROPERTIES:
     :CUSTOM_ID: multiple-ledger-source-blocks-with-noweb
     :CLASS: subsubsection
     :END:
...
**** 7.2.4.6 An overall balance summary
     :PROPERTIES:
     :CUSTOM_ID: an-overall-balance-summary
     :CLASS: subsubsection
     :END:
...
**** 7.2.4.7 Generating a monthly register
     :PROPERTIES:
     :CUSTOM_ID: generating-a-monthly-register
     :CLASS: subsubsection
     :END:
...
**** 7.2.5 The =pricemap= command
     :PROPERTIES:
     :CUSTOM_ID: the-pricemap-command
     :CLASS: subsection
     :END:
...
**** 7.2.7 =prices= and =pricedb= commands
     :PROPERTIES:
     :CUSTOM_ID: prices-and-pricedb-commands
     :CLASS: subsection
     :END:
...
*** 7.3 Reports about your Journals
    :PROPERTIES:
    :CUSTOM_ID: reports-about-your-journals
    :CLASS: section
    :END:
...
*** 8.2 Command-Line Quick Reference
    :PROPERTIES:
    :CUSTOM_ID: command-line-quick-reference
    :CLASS: section
    :END:
...
**** 8.2.1 Basic Reporting Commands
     :PROPERTIES:
     :CUSTOM_ID: basic-reporting-commands
     :CLASS: subsection
     :END:
...
**** 8.2.4 Error Checking and Calculation Options
     :PROPERTIES:
     :CUSTOM_ID: error-checking-and-calculation-options
     :CLASS: subsection
     :END:
...
**** 8.2.5 Output Customization
     :PROPERTIES:
     :CUSTOM_ID: output-customization
     :CLASS: subsection
     :END:
...
*** 8.3 Detailed Option Description
    :PROPERTIES:
    :CUSTOM_ID: detailed-option-description
    :CLASS: section
    :END:
...
**** 8.3.6 Output customization
     :PROPERTIES:
     :CUSTOM_ID: output-customization-1
     :CLASS: subsection
     :END:
...
**** 8.3.7 Commodity reporting
     :PROPERTIES:
     :CUSTOM_ID: commodity-reporting-1
     :CLASS: subsection
     :END:
...
** 9 Budgeting and Forecasting
   :PROPERTIES:
   :CUSTOM_ID: budgeting-and-forecasting
   :CLASS: chapter
   :END:
...
**** 11.1.1 Posting/account details
     :PROPERTIES:
     :CUSTOM_ID: postingaccount-details
     :CLASS: subsection
     :END:
...
*** 12.1 Format String Basics
    :PROPERTIES:
    :CUSTOM_ID: format-string-basics
    :CLASS: section
    :END:
...
*** 12.2 Format String Structure
    :PROPERTIES:
    :CUSTOM_ID: format-string-structure
    :CLASS: section
    :END:
...
*** 12.5 Formatting Functions and Codes
    :PROPERTIES:
    :CUSTOM_ID: formatting-functions-and-codes
    :CLASS: section
    :END:
...
**** 12.5.3 Quantities and Calculations
     :PROPERTIES:
     :CUSTOM_ID: quantities-and-calculations
     :CLASS: subsection
     :END:
...
**** 12.5.5 Date and Time Format Codes
     :PROPERTIES:
     :CUSTOM_ID: date-and-time-format-codes
     :CLASS: subsection
     :END:
...
**** 12.5.5.4 Miscellaneous Date Codes
     :PROPERTIES:
     :CUSTOM_ID: miscellaneous-date-codes
     :CLASS: subsubsection
     :END:
...
**** 12.5.7 Data File Parsing Information
     :PROPERTIES:
     :CUSTOM_ID: data-file-parsing-information
     :CLASS: subsection
     :END:
...
** 13 Extending with Python
   :PROPERTIES:
   :CUSTOM_ID: extending-with-python
   :CLASS: chapter
   :END:
...
*** 13.1 Basic data traversal
    :PROPERTIES:
    :CUSTOM_ID: basic-data-traversal
    :CLASS: section
    :END:
...
** 14 Ledger for Developers
   :PROPERTIES:
   :CUSTOM_ID: ledger-for-developers
   :CLASS: chapter
   :END:
...
*** 14.2 Journal File Format for Developers
    :PROPERTIES:
    :CUSTOM_ID: journal-file-format-for-developers
    :CLASS: section
    :END:
...
**** 14.2.1 Comments and meta-data
     :PROPERTIES:
     :CUSTOM_ID: comments-and-meta-data
     :CLASS: subsection
     :END:
...
**** 14.2.2.2 Commoditized Amounts
     :PROPERTIES:
     :CUSTOM_ID: commoditized-amounts
     :CLASS: subsubsection
     :END:
...
*** 14.4 Ledger Development Environment
    :PROPERTIES:
    :CUSTOM_ID: ledger-development-environment
    :CLASS: section
    :END:
...
**** 14.4.1 acprep build configuration tool
     :PROPERTIES:
     :CUSTOM_ID: acprep-build-configuration-tool
     :CLASS: subsection
     :END:
...
** 15 Major Changes from version 2.6
   :PROPERTIES:
   :CUSTOM_ID: major-changes-from-version-2.6
   :CLASS: chapter
   :END:
...
** Appendix A Example Journal File
   :PROPERTIES:
   :CUSTOM_ID: appendix-a-example-journal-file
   :CLASS: appendix
   :END:
...
** Appendix B Miscellaneous Notes
   :PROPERTIES:
   :CUSTOM_ID: appendix-b-miscellaneous-notes
   :CLASS: appendix
   :END:
...
**** B.1.1 Invoking Ledger
     :PROPERTIES:
     :CUSTOM_ID: b.1.1-invoking-ledger
     :CLASS: subsection
     :END:
...
** Commands & Options Index
   :PROPERTIES:
   :CUSTOM_ID: commands-options-index
   :CLASS: unnumbered
   :END:
